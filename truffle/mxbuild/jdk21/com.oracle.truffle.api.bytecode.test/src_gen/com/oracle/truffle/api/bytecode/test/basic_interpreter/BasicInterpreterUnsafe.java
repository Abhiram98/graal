...
public final class BasicInterpreterUnsafe extends BasicInterpreter {
    ...
    private static final AtomicReferenceFieldUpdater<BasicInterpreterUnsafe, AbstractBytecodeNode> BYTECODE_UPDATER = AtomicReferenceFieldUpdater.newUpdater(BasicInterpreterUnsafe.class, AbstractBytecodeNode.class, "bytecode");
    ...
    private static final ClassValue<Integer> CLASS_TO_TAG_MASK = BasicInterpreterUnsafe.initializeTagMaskToClass();
    ...
    protected RootNode cloneUninitialized() {
        BasicInterpreterUnsafe clone;
        synchronized(nodes){
            clone = (BasicInterpreterUnsafe) this.copy();
            clone.clones = null;
            clone.bytecode = insert(this.bytecode.cloneUninitialized());
            CloneReferenceList<BasicInterpreterUnsafe> localClones = this.clones;
            if (localClones == null) {
                this.clones = localClones = new CloneReferenceList<BasicInterpreterUnsafe>();
            }
    ...
    private BasicInterpreterUnsafe getBytecodeRootNodeImpl(int index) {
        return (BasicInterpreterUnsafe) this.nodes.getNode(index);
    }
    ...
    /**
     * Creates one or more bytecode nodes. This is the entrypoint for creating new {@link BasicInterpreterUnsafe} instances.
     *
     ...
     */
    public static BytecodeRootNodes<BasicInterpreter> create(BytecodeDSLTestLanguage language, BytecodeConfig config, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder> parser) {
     ...
     */
    @TruffleBoundary
    public static void serialize(DataOutput buffer, BytecodeSerializer callback, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder> parser) throws IOException {
    ...
    @TruffleBoundary
    private static void doSerialize(DataOutput buffer, BytecodeSerializer callback, com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder builder, List<BasicInterpreter> existingNodes) throws IOException {
        try {
    ...
    private abstract static sealed class AbstractBytecodeNode extends BytecodeNode permits CachedBytecodeNode, UninitializedBytecodeNode {
        ...
        abstract long continueAt(BasicInterpreterUnsafe $root, VirtualFrame frame, VirtualFrame localFrame, long startState);

        final BasicInterpreterUnsafe getRoot() {
            return (BasicInterpreterUnsafe) getParent();
        }
    ...
    private static final class CachedBytecodeNode extends AbstractBytecodeNode implements BytecodeOSRNode {
        ...
        long continueAt(BasicInterpreterUnsafe $root, VirtualFrame frame, VirtualFrame localFrame, long startState) {
            byte[] bc = this.bytecodes;
        ...
        private void doYield(VirtualFrame frame, VirtualFrame localFrame, byte[] bc, int bci, int sp, BasicInterpreterUnsafe $root) {
        ...
        @InliningCutoff
        private Throwable resolveThrowable(BasicInterpreterUnsafe $root, VirtualFrame frame, int bci, Throwable throwable) {
        ...
        private long resolveControlFlowException(BasicInterpreterUnsafe $root, VirtualFrame frame, int bci, ControlFlowException cfe) throws Throwable {
    ...
    public static final class Builder extends BasicInterpreterBuilder {
        ...
        private final ArrayList<BasicInterpreterUnsafe> builtNodes;
        ...
        public BasicInterpreter endRoot() {
            ...
            if (reparseReason != null) {
                ...
                result = new BasicInterpreterUnsafe(language, frameDescriptorBuilder, nodes, maxLocals + USER_LOCALS_START_INDEX, operationData.index, bytecodes_, constants_, handlers_, locals_, sourceInfo_, sources_, numNodes_, tagRoot_);
        ...
        private void finish() {
            ...
            if (reparseReason == null) {
                nodes.setNodes(builtNodes.toArray(new BasicInterpreterUnsafe[0]));
            }
                    ...
                    switch (code) {
                        ...
                        case SerializationState.CODE_$END :
                        {
                            for (int i = 0; i < this.builtNodes.size(); i++) {
                                BasicInterpreterUnsafe node = this.builtNodes.get(i);
                        ...
                        {
                            BasicInterpreterUnsafe node = (BasicInterpreterUnsafe) endRoot();
        ...
        public String toString() {
            ...
            b.append(BasicInterpreterUnsafe.class.getSimpleName());
            b.append('.');
            b.append(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder.class.getSimpleName());
            b.append("[");
            b.append("at=");
        ...
        private static class OperationStackEntry {
            ...
            private String toString(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder builder) {
                StringBuilder b = new StringBuilder();
    ...
    private static final class BytecodeRootNodesImpl extends BytecodeRootNodes<BasicInterpreter> {
        ...
        BytecodeRootNodesImpl(BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder> generator, BytecodeConfig config) {
        ...
        private synchronized boolean performUpdate(long maskedEncoding) {
            ...
            BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder> parser = getParserImpl();
            ...
            for (BasicInterpreter node : nodes) {
                builder.builtNodes.add((BasicInterpreterUnsafe) node);
            }
            parser.parse(builder);
            builder.finish();
        ...
        private void setNodes(BasicInterpreterUnsafe[] nodes) {
            if (this.nodes != null) {
                throw new AssertionError();
            }
            this.nodes = nodes;
            for (BasicInterpreterUnsafe node : nodes) {
        ...
        @SuppressWarnings("unchecked")
        private BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder> getParserImpl() {
            return (BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterUnsafe.Builder>) super.getParser();
        }

        private boolean validate() {
            for (BasicInterpreter node : nodes) {
                ((BasicInterpreterUnsafe) node).getBytecodeNodeImpl().validateBytecodes();
            }
            return true;
        }
        ...
        public void serialize(DataOutput buffer, BytecodeSerializer callback) throws IOException {
            ...
            for (int i = 0; i < nodes.length; i++) {
                existingNodes.add((BasicInterpreterUnsafe) nodes[i]);
            }
            BasicInterpreterUnsafe.doSerialize(buffer, callback, new Builder(getLanguage(), this, BytecodeConfig.COMPLETE), existingNodes);
        }
    ...
    private static final class ContinuationRootNodeImpl extends ContinuationRootNode {
        ...
        final BasicInterpreterUnsafe root;
        final int sp;
        @CompilationFinal volatile BytecodeLocation location;

        ContinuationRootNodeImpl(TruffleLanguage<?> language, FrameDescriptor frameDescriptor, BasicInterpreterUnsafe root, int sp, BytecodeLocation location) {
